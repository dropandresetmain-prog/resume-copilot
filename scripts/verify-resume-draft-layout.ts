...
function main() {
  ...
  const checks: [string, boolean][] = [
    ...
    ["fit score uses preview heuristic version", assessment.heuristicVersion === PREVIEW_FIT_HEURISTIC_VERSION],
    ["fit score rubric version constant exported", FIT_SCORE_RUBRIC_VERSION === "fit-rubric-v1"],
