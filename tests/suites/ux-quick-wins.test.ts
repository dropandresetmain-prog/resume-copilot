...
function main() {
  ...
  const checks: [string, boolean][] = [
    ["app version constant", appVersion.includes('APP_VERSION = "0.9.16B"')],
    ["package json version", packageJson.includes('"version": "0.9.16B"')],
    ...
    [
      "v0.9.13A documented",
      handoff.includes("v0.9.13A") && roadmap.includes("v0.9.13A"),
    ],
    [
      "v0.9.13B documented",
    ...
    [
      "v0.9.15A documented",
      handoff.includes("v0.9.15A") && roadmap.includes("v0.9.15A"),
    ],
    [
      "v0.9.15B documented",
    ...
    [
      "v0.9.15C documented",
      handoff.includes("v0.9.15C") && roadmap.includes("v0.9.15C"),
    ],
    [
      "v0.9.15D documented",
      handoff.includes("v0.9.15D") && roadmap.includes("v0.9.15D"),
    ],
    [
      "v0.9.16B documented",
      handoff.includes("v0.9.16B") && roadmap.includes("v0.9.16B"),
    ],
    [
      "v0.9.16A documented",
      handoff.includes("v0.9.16A") && roadmap.includes("v0.9.16A"),
    ],
    [
      "v0.9.15E documented",
      handoff.includes("v0.9.15E") && roadmap.includes("v0.9.15E"),
    ],
    [
