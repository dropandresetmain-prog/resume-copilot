...
async function main() {
  ...
  const checks: [string, boolean][] = [
    ...
    ["status label formats resume_generated", formatApplicationStatusLabel("resume_generated") === "Ready"],
    ...
    ["M6: artifact presence shown per record", applicationsPageClient.includes('data-testid="artifact-resume"') && applicationsPageClient.includes('data-testid="artifact-cover-letter"')],
