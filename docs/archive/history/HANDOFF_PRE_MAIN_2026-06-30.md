...
> Archived pre-merge handoff and v0.9.x milestone history. Use [`../../HANDOFF.md`](../../HANDOFF.md) for current state.
...
Full redesign brief: [`docs/FOLIO_REDESIGN.md`](../../FOLIO_REDESIGN.md). Recovery roadmap + milestone log: [`docs/FOLIO_RECOVERY_ROADMAP.md`](../recovery/FOLIO_RECOVERY_ROADMAP.md). Supporting docs: [`FOLIO_DESIGN_TOKENS.md`](../../FOLIO_DESIGN_TOKENS.md), [`CAREER_VAULT.md`](../../CAREER_VAULT.md).
...
**Next:** M1 Unified Evidence Spine. Manual live QA: [`PHASE0_MANUAL_QA.md`](../milestones/PHASE0_MANUAL_QA.md).
