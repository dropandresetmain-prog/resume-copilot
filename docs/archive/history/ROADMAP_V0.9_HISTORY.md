...
> Archived v0.9 milestone log and pre-merge roadmap. Use [`../../ROADMAP.md`](../../ROADMAP.md) for current priorities.
...
| Phase | Theme | Status |
|-------|-------|--------|
| 0 | Audit — routes, AI calls, data models | ✅ [`AUDIT_CLAUDE.md`](../audits/AUDIT_CLAUDE.md) |
