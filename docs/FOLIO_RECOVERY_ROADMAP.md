...
| **M11** | Output Editor v2 — unified staging + batched apply + content/layout gate; Vault structured editing | Make editing deliberate/batched/consistent; independent review required | High |
