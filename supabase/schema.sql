...
-- ---------------------------------------------------------------------------
-- application_communication_profiles (v0.9.0)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- generated_cover_letter_drafts (v0.9.0)
-- ---------------------------------------------------------------------------
create table if not exists public.generated_cover_letter_drafts (
  ...
  application_id uuid references public.application_records(id) on delete cascade,
  job_description_id uuid references public.job_descriptions(id) on delete set null,
  resume_draft_id uuid references public.generated_resume_drafts(id) on delete set null,
  company_name text,
  country text,
